...
// **********
double Anneal::order(const VecDoub &x, const VecDoub &y, VecInt &iorder)
{
...
// **********
double Anneal::revcst(const VecDoub &x, const VecDoub &y, VecInt &iorder, VecInt &n)
{
	VecDoub xx(4), yy(4);
	int ncity = x.size();
...
// **********
double Anneal::trncst(const VecDoub &x, const VecDoub &y, VecInt &iorder, VecInt &n)
{
	VecDoub xx(6), yy(6);
	int ncity = x.size();
