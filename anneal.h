...
//      List of auxiliary functions that are defined outside of the class
		double revcst (const VecDoub & x, const VecDoub & y, VecInt & iorder, VecInt & n);

		void reverse (VecInt & iorder, VecInt & n);

		double trncst (const VecDoub & x, const VecDoub & y, VecInt & iorder, VecInt & n);
...
//      iorder is a VecInt vector in which the optimal sequence will be stored
		double order (const VecDoub & x, const VecDoub & y, VecInt & iorder);
};


// **********
double
Anneal::order (const VecDoub & x, const VecDoub & y, VecInt & iorder)
{
	...
	//otherwise non-void may have no return
	return 0.0;
}
...
// **********
double
Anneal::revcst (const VecDoub & x, const VecDoub & y, VecInt & iorder, VecInt & n)
{
